import {Alert, Button, Container, Group, Loader, Modal, SimpleGrid, Stack, Text,} from "@mantine/core"
        ...
        return (
            <Container size="lg" py="xl">
                <Alert color="red" variant="light" title="Group not found">
                    This group doesn&apos;t exist in our demo data yet. Return to the groups overview to try another
                    one.
                </Alert>
            </Container>
        )
            ...
            <Modal opened={showSettingsModal} onClose={settingsModalHandlers.close} title="Group settings">
                <Stack gap="sm">
                    <Text size="sm" c="dimmed">
                        Settings editing is not wired to the backend yet. You can imagine controls for invite links,
                        ownership
            ...
            >
                <Stack gap="md">
                    ...
                    <Group justify="flex-end">
                        ...
                        <Button
                            color="red"
                            onClick={() => memberRemovalCandidate && handleRemoveMember(memberRemovalCandidate.id)}
                        >
                            Remove
                        </Button>
                    </Group>
